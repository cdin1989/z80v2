...
;----------------------------------------------------------------------
; Block and wait until the CF card is not busy
;----------------------------------------------------------------------
CF_Wait_NotBusy:
    IN   A, (CF_REG7)
    AND  CF_BUSY
    JR   NZ, CF_Wait_NotBusy
    RET

;----------------------------------------------------------------------
; Block and wait until until the CF card is ready
;----------------------------------------------------------------------
CF_Wait_Ready:
    IN   A, (CF_REG7)
    AND  CF_RDY
...
;----------------------------------------------------------------------
; Block and wait until data transfer is ready
;----------------------------------------------------------------------
CF_Wait_DataReady:
    IN   A, (CF_REG7)
    AND  CF_DRQ
    JR   Z, CF_Wait_DataReady
    RET
